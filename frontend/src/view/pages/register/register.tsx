...
const formSchema = z.object({
    email: z.string('Email Invalido').email({ message: 'Email inválido' }),
            ...
            <div className='w-full h-full  gap-3 flex flex-col justify-center items-center  '>
                ...
                <div className='w-full max-w-110 flex  flex-col gap-y-3'>
                    ...
                    >
                        ...
                        <InputGroup
                            className={`h-13 border-green-700 ${form.formState.errors.email ? 'border-red-400' : ''}`}
                        >
                            <InputGroupInput
                                type='email'
                        ...
                        <InputGroup
                            className={`h-13 border-green-700 ${form.formState.errors.password ? 'border-red-400' : ''}`}
                        >
                            <InputGroupInput
                                type='password'
